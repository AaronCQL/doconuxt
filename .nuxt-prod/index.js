...
import nuxt_plugin_plugin_0bbb733e from 'nuxt_plugin_plugin_0bbb733e' // Source: ./components/plugin.js (mode: 'all')
...
async function createApp(ssrContext, config = {}) {
  ...
  if (typeof nuxt_plugin_plugin_0bbb733e === 'function') {
    await nuxt_plugin_plugin_0bbb733e(app.context, inject)
  }

  if (process.client && typeof nuxt_plugin_pluginclient_1bb56fba === 'function') {
    await nuxt_plugin_pluginclient_1bb56fba(app.context, inject)
  }

  if (process.server && typeof nuxt_plugin_pluginserver_fd223d7c === 'function') {
    await nuxt_plugin_pluginserver_fd223d7c(app.context, inject)
  }
  ...
  if (typeof nuxt_plugin_navLinks_3e6bb126 === 'function') {
    await nuxt_plugin_navLinks_3e6bb126(app.context, inject)
  }

  if (typeof nuxt_plugin_fontawesome_29e6161c === 'function') {
    await nuxt_plugin_fontawesome_29e6161c(app.context, inject)
  }
