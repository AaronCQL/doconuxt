...
exports = ___CSS_LOADER_API_IMPORT___(false);
// Module
exports.push([module.i, "/*! normalize.css v8.0.1 | MIT License | github.com/necolas/normalize.css */html{line-height:1.15;-webkit-text-size-adjust:100%}body{margin:0}main{display:block}h1{font-size:2em;margin:.67em 0}hr{box-sizing:content-box;height:0;overflow:visible}pre{font-family:monospace,monospace;font-size:1em}a{background-color:transparent}abbr[title]{border-bottom:none;text-decoration:underline;-webkit-text-decoration:underline dotted;text-decoration:underline dotted}b,strong{font-weight:bolder}code,kbd,samp{font-family:monospace,monospace;font-size:1em}small{font-size:80%}sub,sup{font-size:75%;line-height:0;position:relative;vertical-align:baseline}sub{bottom:-.25em}sup{top:-.5em}img{border-style:none}button,input,optgroup,select,textarea{font-family:inherit;font-size:100%;line-height:1.15;margin:0}button,input{overflow:visible}button,select{text-transform:none}[type=button],[type=reset],[type=submit],button{-webkit-appearance:button}[type=button]::-moz-focus-inner,[type=reset]::-moz-focus-inner,[type=submit]::-moz-focus-inner,button::-moz-focus-inner{border-style:none;padding:0}[type=button]:-moz-focusring,[type=reset]:-moz-focusring,[type=submit]:-moz-focusring,button:-moz-focusring{outline:1px dotted ButtonText}fieldset{padding:.35em .75em .625em}legend{box-sizing:border-box;color:inherit;display:table;max-width:100%;padding:0;white-space:normal}progress{vertical-align:baseline}textarea{overflow:auto}[type=checkbox],[type=radio]{box-sizing:border-box;padding:0}[type=number]::-webkit-inner-spin-button,[type=number]::-webkit-outer-spin-button{height:auto}[type=search]{-webkit-appearance:textfield;outline-offset:-2px}[type=search]::-webkit-search-decoration{-webkit-appearance:none}::-webkit-file-upload-button{-webkit-appearance:button;font:inherit}details{display:block}summary{display:list-item}[hidden],template{display:none}blockquote,dd,dl,figure,h1,h2,h3,h4,h5,h6,hr,p,pre{margin:0}button{background-color:transparent;background-image:none;padding:0}button:focus{outline:1px dotted;outline:5px auto -webkit-focus-ring-color}fieldset,ol,ul{margin:0;padding:0}ol,ul{list-style:none}html{font-family:system-ui,-apple-system,Segoe UI,Roboto,Ubuntu,Cantarell,Noto Sans,sans-serif,BlinkMacSystemFont,Helvetica Neue,Arial,Apple Color Emoji,Segoe UI Emoji,Segoe UI Symbol,Noto Color Emoji;line-height:1.5}*,:after,:before{box-sizing:border-box;border:0 solid #e2e8f0}hr{border-top-width:1px}img{border-style:solid}textarea{resize:vertical}input::-moz-placeholder,textarea::-moz-placeholder{color:#a0aec0}input:-ms-input-placeholder,textarea:-ms-input-placeholder{color:#a0aec0}input::-ms-input-placeholder,textarea::-ms-input-placeholder{color:#a0aec0}input::placeholder,textarea::placeholder{color:#a0aec0}[role=button],button{cursor:pointer}table{border-collapse:collapse}h1,h2,h3,h4,h5,h6{font-size:inherit;font-weight:inherit}a{color:inherit;text-decoration:inherit}button,input,optgroup,select,textarea{padding:0;line-height:inherit;color:inherit}code,kbd,pre,samp{font-family:Menlo,Monaco,Consolas,Liberation Mono,Courier New,monospace}audio,canvas,embed,iframe,img,object,svg,video{display:block;vertical-align:middle}img,video{max-width:100%;height:auto}.container{width:100%}@media (min-width:640px){.container{max-width:640px}}@media (min-width:768px){.container{max-width:768px}}@media (min-width:1024px){.container{max-width:1024px}}@media (min-width:1280px){.container{max-width:1280px}}.space-y-1>:not(template)~:not(template){--space-y-reverse:0;margin-top:calc(0.25rem*(1 - var(--space-y-reverse)));margin-bottom:calc(0.25rem*var(--space-y-reverse))}.bg-white{--bg-opacity:1;background-color:#fff;background-color:rgba(255,255,255,var(--bg-opacity))}.bg-gray-200{--bg-opacity:1;background-color:#edf2f7;background-color:rgba(237,242,247,var(--bg-opacity))}.bg-primary{--bg-opacity:1;background-color:#3eaf7c;background-color:rgba(62,175,124,var(--bg-opacity))}.bg-opacity-10{--bg-opacity:0.1}.border-gray-400{--border-opacity:1;border-color:#cbd5e0;border-color:rgba(203,213,224,var(--border-opacity))}.rounded{border-radius:.25rem}.rounded-md{border-radius:.375rem}.border-b{border-bottom-width:1px}.cursor-pointer{cursor:pointer}.flex{display:flex}.hidden{display:none}.flex-col{flex-direction:column}.items-center{align-items:center}.justify-between{justify-content:space-between}.flex-1{flex:1 1 0%}.font-semibold{font-weight:600}.font-bold{font-weight:700}.font-extrabold{font-weight:800}.h-16{height:4rem}.h-screen{height:100vh}.text-lg{font-size:1.125rem}.text-xl{font-size:1.25rem}.text-2xl{font-size:1.5rem}.text-4xl{font-size:2.25rem}.m-auto{margin:auto}.max-h-full{max-height:100%}.focus\\:outline-none:focus{outline:0}.overflow-y-auto{overflow-y:auto}.overflow-y-hidden{overflow-y:hidden}.p-4{padding:1rem}.py-1{padding-top:.25rem;padding-bottom:.25rem}.py-2{padding-top:.5rem;padding-bottom:.5rem}.px-2{padding-left:.5rem;padding-right:.5rem}.px-4{padding-left:1rem;padding-right:1rem}.static{position:static}.fixed{position:fixed}.shadow-lg{box-shadow:0 10px 15px -3px rgba(0,0,0,.1),0 4px 6px -2px rgba(0,0,0,.05)}.text-center{text-align:center}.text-gray-800{--text-opacity:1;color:#2d3748;color:rgba(45,55,72,var(--text-opacity))}.text-green-700{--text-opacity:1;color:#2f855a;color:rgba(47,133,90,var(--text-opacity))}.hover\\:text-primary:hover{--text-opacity:1;color:#3eaf7c;color:rgba(62,175,124,var(--text-opacity))}.w-full{width:100%}.w-screen{width:100vw}.z-40{z-index:40}.z-50{z-index:50}@media (min-width:1024px){.lg\\:border-r{border-right-width:1px}.lg\\:block{display:block}.lg\\:flex{display:flex}.lg\\:hidden{display:none}.lg\\:max-w-xs{max-width:20rem}.lg\\:px-12{padding-left:3rem;padding-right:3rem}.lg\\:static{position:static}.lg\\:shadow-none{box-shadow:none}.lg\\:w-3\\/12{width:25%}}", ""]);
// Exports
module.exports = exports;
...
exports = ___CSS_LOADER_API_IMPORT___(false);
// Module
exports.push([module.i, ".nuxt-content{padding-left:1rem;padding-right:1rem}.nuxt-content h1,.nuxt-content h2,.nuxt-content h3,.nuxt-content h4,.nuxt-content h5,.nuxt-content h6{margin-top:1.5rem;margin-bottom:1rem}.nuxt-content h1:hover,.nuxt-content h2:hover,.nuxt-content h3:hover,.nuxt-content h4:hover,.nuxt-content h5:hover,.nuxt-content h6:hover{--text-opacity:1;color:#3eaf7c;color:rgba(62,175,124,var(--text-opacity));cursor:pointer}.nuxt-content h1:hover:before,.nuxt-content h2:hover:before,.nuxt-content h3:hover:before,.nuxt-content h4:hover:before,.nuxt-content h5:hover:before,.nuxt-content h6:hover:before{content:\"# \";font-weight:300}.nuxt-content h1{font-size:2.25rem;font-weight:800}.nuxt-content h1,.nuxt-content h2{border-bottom-width:1px;--border-opacity:1;border-color:#edf2f7;border-color:rgba(237,242,247,var(--border-opacity))}.nuxt-content h2{font-size:1.875rem;font-weight:700}.nuxt-content h3{font-size:1.5rem;font-weight:700}.nuxt-content h4{font-size:1.25rem;font-weight:700}.nuxt-content h5{font-size:1.125rem;font-weight:700}.nuxt-content h6{font-size:1rem;font-weight:700}.nuxt-content p{margin-top:1rem}.nuxt-content strong{font-weight:700}.nuxt-content a:hover{text-decoration:underline}.nuxt-content a{--text-opacity:1;color:#3eaf7c;color:rgba(62,175,124,var(--text-opacity));font-weight:600}.nuxt-content li>code,.nuxt-content p>code,.nuxt-content td>code,.nuxt-content th>code{--bg-opacity:1;background-color:#edf2f7;background-color:rgba(237,242,247,var(--bg-opacity));padding:.25rem;border-radius:.375rem;-webkit-user-select:all;-moz-user-select:all;-ms-user-select:all;user-select:all}.nuxt-content>ol,.nuxt-content>ul{margin-bottom:1rem;margin-left:1rem}.nuxt-content ul{list-style-type:disc;list-style-position:outside}.nuxt-content ol{list-style-type:decimal;list-style-position:outside}.nuxt-content li{margin-left:1.5rem;margin-top:.25rem}.nuxt-content .task-list-item{list-style-type:none}.nuxt-content .task-list-item input{float:left;margin-left:-1.3em;margin-top:.35em}.nuxt-content blockquote{border-left-width:4px;--border-opacity:1;border-color:#cbd5e0;border-color:rgba(203,213,224,var(--border-opacity));padding-left:.5rem;--text-opacity:1;color:#4a5568;color:rgba(74,85,104,var(--text-opacity))}.nuxt-content table{border-collapse:collapse}.nuxt-content td,.nuxt-content th{border-width:1px;--border-opacity:1;border-color:#cbd5e0;border-color:rgba(203,213,224,var(--border-opacity));padding:.25rem .75rem}.nuxt-content thead{--bg-opacity:1;background-color:#edf2f7;background-color:rgba(237,242,247,var(--bg-opacity))}", ""]);
// Exports
module.exports = exports;
...
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
__webpack_require__(2).default("517a8dd7", content, true)
...
exports = ___CSS_LOADER_API_IMPORT___(false);
// Module
exports.push([module.i, ".link-active.nuxt-link-exact-active{--text-opacity:1;color:#2f855a;color:rgba(47,133,90,var(--text-opacity));--bg-opacity:1;background-color:#3eaf7c;background-color:rgba(62,175,124,var(--bg-opacity));--bg-opacity:0.1;border-radius:.25rem;padding-left:.5rem;padding-right:.5rem}.content-max-height{max-height:calc(100vh - 4rem)}", ""]);
// Exports
module.exports = exports;
...
const _e26ab054 = () => interopDefault(__webpack_require__.e(/* import() | pages/index */ 2).then(__webpack_require__.bind(null, 39)));

const _e5d7f2e4 = () => interopDefault(__webpack_require__.e(/* import() | pages/_slug */ 1).then(__webpack_require__.bind(null, 40))); // TODO: remove in Nuxt 3
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./layouts/default.vue?vue&type=template&id=eafa8afa&
var defaultvue_type_template_id_eafa8afa_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_vm._ssrNode("<nav class=\"z-50 bg-white w-full h-16 px-4 lg:px-12 border-b border-gray-400 flex justify-between items-center\">","</nav>",[_c('nuxt-link',{staticClass:"cursor-pointer text-2xl font-bold hover:text-primary",attrs:{"to":"/"}},[_vm._v("\n      Nuxt Content Docs Template\n    ")]),_vm._ssrNode(" "),_vm._ssrNode("<div>","</div>",[_vm._ssrNode("<input placeholder=\"Search text\" type=\"text\" class=\"bg-gray-200 py-1 px-2 text-lg rounded-md focus:outline-primary hidden lg:block\"> "),_vm._ssrNode("<button title=\"Toggle Navigation\" class=\"lg:hidden focus:outline-none px-4 py-2 text-xl hover:text-primary\">","</button>",[(_vm.isNavOpen)?_c('font-awesome-icon',{attrs:{"icon":"times"}}):_c('font-awesome-icon',{attrs:{"icon":"bars"}})],1)],2)],2),_vm._ssrNode(" "),_vm._ssrNode("<div class=\"flex h-screen content-max-height overflow-y-hidden\">","</div>",[_vm._ssrNode("<nav"+(_vm._ssrClass("z-40 bg-white fixed lg:static max-h-full w-screen lg:w-3/12 lg:max-w-xs overflow-y-auto lg:border-r p-4 flex-col shadow-lg lg:shadow-none space-y-1",_vm.isNavOpen ? 'flex' : 'hidden lg:flex'))+">","</nav>",_vm._l((_vm.navLinks),function(link){return _c('nuxt-link',{key:link.title,staticClass:"cursor-pointer text-lg font-semibold hover:text-primary text-gray-800 w-full link-active",attrs:{"to":link.path},nativeOn:{"click":function($event){return _vm.closeNav($event)}}},[_vm._v("\n        "+_vm._s(link.title)+"\n      ")])}),1),_vm._ssrNode(" "),_c('Nuxt',{staticClass:"flex-1 overflow-y-auto"})],2)],2)}
var defaultvue_type_template_id_eafa8afa_staticRenderFns = []


// CONCATENATED MODULE: ./layouts/default.vue?vue&type=template&id=eafa8afa&
...
var default_component = Object(componentNormalizer["a" /* default */])(
  ...
  defaultvue_type_template_id_eafa8afa_render,
  defaultvue_type_template_id_eafa8afa_staticRenderFns,
  false,
...
var _nuxt_prod_empty = __webpack_require__(37);
...
var vue_fontawesome_ = __webpack_require__(19);
...
fontawesome_svg_core_["library"].add(free_solid_svg_icons_["faTimes"], free_solid_svg_icons_["faBars"]); // Register the component globally
