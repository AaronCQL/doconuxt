...
exports = ___CSS_LOADER_API_IMPORT___(false);
// Module
exports.push([module.i, ".nuxt-content{padding-left:1rem;padding-right:1rem}.nuxt-content h1,.nuxt-content h2,.nuxt-content h3,.nuxt-content h4,.nuxt-content h5,.nuxt-content h6{margin-top:1.5rem;margin-bottom:1rem}.nuxt-content h1:hover,.nuxt-content h2:hover,.nuxt-content h3:hover,.nuxt-content h4:hover,.nuxt-content h5:hover,.nuxt-content h6:hover{cursor:pointer}.nuxt-content h1{font-size:1.875rem;font-weight:800}.nuxt-content h1,.nuxt-content h2{border-bottom-width:1px;--border-opacity:1;border-color:#edf2f7;border-color:rgba(237,242,247,var(--border-opacity))}.nuxt-content h2{font-size:1.5rem;font-weight:700}.nuxt-content h3{font-size:1.25rem;font-weight:700}.nuxt-content h4{font-size:1.125rem;font-weight:700}.nuxt-content p{margin-top:1rem;margin-bottom:1rem}.nuxt-content strong{font-weight:600}.nuxt-content a:hover{text-decoration:underline}.nuxt-content a{--text-opacity:1;color:#3eaf7c;color:rgba(62,175,124,var(--text-opacity));font-weight:600}.nuxt-content li>code,.nuxt-content p>code,.nuxt-content td>code,.nuxt-content th>code{--bg-opacity:1;background-color:#edf2f7;background-color:rgba(237,242,247,var(--bg-opacity));border-radius:.25rem;-webkit-user-select:all;-moz-user-select:all;-ms-user-select:all;user-select:all;padding:.1rem .2rem}.nuxt-content>ol,.nuxt-content>ul{margin-bottom:1rem}.nuxt-content ul{list-style-type:disc;list-style-position:outside}.nuxt-content ol{list-style-type:decimal;list-style-position:outside}.nuxt-content li{margin-left:1.25rem;padding-left:.25rem;margin-top:.25rem;margin-bottom:.25rem}.nuxt-content .task-list-item{list-style-type:none}.nuxt-content .task-list-item input{float:left;margin-left:-1.3em;margin-top:.35em}.nuxt-content blockquote{border-left-width:4px;--border-opacity:1;border-color:#cbd5e0;border-color:rgba(203,213,224,var(--border-opacity));padding-left:.5rem;--text-opacity:1;color:#4a5568;color:rgba(74,85,104,var(--text-opacity))}.nuxt-content table{border-collapse:collapse}.nuxt-content td,.nuxt-content th{border-width:1px;--border-opacity:1;border-color:#cbd5e0;border-color:rgba(203,213,224,var(--border-opacity));padding:.25rem .75rem}.nuxt-content thead{--bg-opacity:1;background-color:#edf2f7;background-color:rgba(237,242,247,var(--bg-opacity))}", ""]);
// Exports
module.exports = exports;
